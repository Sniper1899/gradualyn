...
$(function() {
  ...
  // --------------------------------------------- //
  $('#countdown').countdown({
    until: $.countdown.UTCDate(+10, 2025, 4, 31),
    format: 'D'
  });  
  // --------------------------------------------- //
  // KBW-Countdown End
...
document.getElementById('celebrate-btn').addEventListener('click', function(event) {
  // Evitar que el formulario o enlace realice alguna acción de navegación
  ...
  if(bgndKenburns.length){
    bgndKenburns.vegas({
      ...
      slides: [
        { src: "https://dummyimage.com/900x1200/575757/949494" },
        { src: "https://dummyimage.com/900x1200/575757/949494" },
        { src: "https://dummyimage.com/900x1200/575757/949494" }
      ],
